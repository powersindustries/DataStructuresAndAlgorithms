...
// ----------------------------------------------------------------
// ----------------------------------------------------------------
void SingleLinkedList::AddNodeToEnd(int data)
{
...
// ----------------------------------------------------------------
// ----------------------------------------------------------------
void SingleLinkedList::AddNodeToBeginning(int data)
{
    SNode* newNode = new SNode();
    newNode->m_Data = data;
...
// ----------------------------------------------------------------
// ----------------------------------------------------------------
void SingleLinkedList::InsertNode(int data, unsigned int index)
{
    if (index == 0)
    {
...
// ----------------------------------------------------------------
// ----------------------------------------------------------------
void SingleLinkedList::DeleteNode(unsigned int index)
{
    ...
    SNode* nextNode = tempNode->m_NextNode->m_NextNode;
...
// ----------------------------------------------------------------
// ----------------------------------------------------------------
void DoubleLinkedList::InsertNode(int data, unsigned int index)
{
    if (index > m_NodeCount)
    {
...
// ----------------------------------------------------------------
// ----------------------------------------------------------------
void DoubleLinkedList::DeleteNode(unsigned int index)
{
    if (index > m_NodeCount)
    {
...
{
    DNode* tempNode = nullptr;
    DNode* currentNode = m_HeadNode;
